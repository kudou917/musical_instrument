# キーパッドに特定の音をそれぞれ割り当てて音を出力するテスト

![写真](S__17661959.jpg)


[演奏動画](802596416.173644.mp4)

以上の画像の通りであるが、基本プロジェクトのキーパッドと基本は同様。画像では視認しにくいが、パッシブブザーとオクターブを上げるためのタクトスイッチをブレッドボードから接続している。

キーパッドの方で使っているキーは12～13ほどしかないのでうまくいけば7ピンまで使用ピンを減らすことが出来る。
